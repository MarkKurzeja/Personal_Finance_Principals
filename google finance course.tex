...
%\begin{topic}{}
%		\begin{prin}{Principal G1:} \end{prin}
%\end{topic}
%
%
%\begin{topic}{}
...
%\begin{topic}{General Rules of Investing (Not Gambling)}
	%        \noindent Investing is not gambling. It is OK to gamble, but that is seperate from investing and should be treated as such. There are a few good heuristics that will steer you in the right direction when you are looking at potenntial investments:
	%        \begin{compactdesc}
	%            \item[The Principal of Savings Rate] Your savings rate is the most important thing under your control. It dwarfs every other variable and it is the single most important variable you can influence. Optimize it to be as high as humanly possible
	%            \item[The Pricnipal of Time] Second only to your savings rate, how long you have been investing is a critical factor in your success. If it means months of analysis or 30 minutes to a decisoin, you should always aim to start now rather than later. Money left uninvested, or worse, spent, is the easiest way to slow your growth of your investment portfolio
	%            \item[The Principal of Liquidity] You should be able to get your money out of an investment in a few weeks time at the maximum and preferably within 2-3 days at the longest 
	%            \item[The Principal of Pooling Multiple Assets] If your asset does not have at least 10-20 equity positions in the security (this is checking if it is an index fund or not) or is not at least an 'A' rated bond, you should probably think twice before you invest
	%            \item[The Principal of Diversification] You should never concenrate more than 60\% of your wealth in any one index fund or asset class. Choose from a variety of stocks, bonds, sectors, currencies, etc
	%            \item[The Principal of Fees] If you pay more than 0.50\% on any of your funds, you are getting robbed and should drop that fund. If you stick with Vanguard, you are almost always safe
	%            \item[The Principal of Boring] If you were to be locked in a cave for the next month, your finances should be fine wihtout your guidance. If you need to check on them any more frequently than once a month (pref. once a quarter), then you are probably gambling and not investing
	%            \item[The Principal of Automation] If you were to be locked in a cave for the next year, your finances should be self-funding and automated. Contributions to your Roth, 401, etc should be automatic, algorithmic, and not micro-managed
	%            \item[The Principal of Dollar-Cost Averaging] If you have \$10,000 to invest, you can reduce the risk of the investment by investing it over a longer time horizon instead of all at once
	%            \item[The Principal of Shiny Toys] Don't think that you need to choose the newest, best, highest yielding instrument. Refer to the Principal of Boring. Your investments should be pretty boring to avoid emotional swings
	%            \item[The Principal of Taxes] Don't begin optimizing for taxes until you have optimized for your savings rate - nothing is as important as your savings rate and ensuring that it is as high as possible
	%        \end{compactdesc}
	%    \end{topic}



%	\begin{topic}{Introduction} Financial independence is about the day that you can tell your boss to go-fish. It is not retirement. Retirement is the day that you reach financial independence and choose not to work. Most people who have financial independence choose to keep working. 
%		\begin{tellme}{Opening Questions}
%			Imagine you are outside playing with your kids. Imagine you could pay \$$ x $ to have another day off of work to enjoy your time with them. What is \$$ x $
%		\end{tellme}
%		\begin{tellme}{Motivations of this Course}
%			\begin{compactitem}
%				\item This course is not to make you hate work or think of work negatively. It is to think of freedom positively. What would you do with a free day? 
%				\item My goal is not to change your actions. I am trying to change the way that you think
%			\end{compactitem}		
%		\end{tellme}
%		\begin{tellme}{Future You vs Current You}
%			There is a battle between future you and current you. Future you is not current you, and will have different dreams, aspirations, constraints, and relationships. Much of personal finance is making sure that you are able to live life today and not mess up life for future you. Current you wants things now. Future you is usually shafted as a result. Life is not about constraining current you while still ensuring that future you feels like they are not constrained as well. 
%		\end{tellme}
%	\end{topic}
%	
%	\begin{topic}{Overview} 
%        For financial course, first concept: I am not trying to make you hate work or if you work negatively, I am trying to make you view freedom appropriately. Cost of AJ question how much would you give not to go into work whenever you want to play with your kids? Also, I am not trying to change what you do. I am trying to change how you think. Often times, if you change how you think, the way that you do stuff will change as well. Second concept: concept of future you versus previous you, any bad thing that has happened in your life is a result of previous you shafting future you. Sometimes decisions are made with incomplete information, how much would you pay to update that information to make better life outcomes? Future you getting shafted by previous you. Third concept: imagine playing a casino game with output function of a normal distribution. Then hide the distribution of the return. Then connected with a Hey Line, does that change the way you look at things? Fourth concepts: the value of information, hiking up a cliff. Example about food. You can add insurance by adding another backpack of food to mitigate the effect of adverse outcomes. Or you can incorporate exit options into your plan along with flexibility to update your current path of action.		
%	\end{topic}
%	
%    \begin{topic}{Retirement Accounts}
%        \noindent There are two main types of retirement accounts that are common in America 
%        \begin{compactdesc}
%            \item[Tax Deffered] You contribute pre-tax dollars to the account, your investments grow tax free, and then you are taxed on the appreciation as ordianry income when you withdraw. There are two main vehnicles for this:
%            \begin{compactitem}
%                \item 401k
%                \item Traditional IRA
%            \end{compactitem}
%            \item[Post-Tax Contributions] You contribute post-tax dollars to the account, your investments grow tax free, and then you are allowed to take out the appreciation tax free. There is only one investment vehicle that allows this: The Roth IRA
%        \end{compactdesc}
%        Usually an example helps out the most. Imagine that you are 25 years old, your current tax rate is 30\%, your tax rate at age 60 is 25\%, and you earn 5\% on your investments annually. Here are the returns for each case:    
%        \begin{compactenum}
%        \item 401k: You earn \$100 today. You aren't taxed on your contribuiton so you put \$100 in your 401k. You then compound it tax free for 35 years to yield a total investment size of $100 \times (1.05)^35 = \$551.60$ which is comprised of \$100 of contributions and \$451.60 of interest. You are taxed on the full amount so you end up with $(1-25\%) \times \$551.60 = \$413.70$
%        \item Roth IRA: You earn \$100 today. You are taxed on your contribuiton so you put $\$100\times (1 - 30\%) = \$70$ in your Roth IRA. You then compound it tax free for 35 years to yield a total investment size of $70 \times (1.05)^35 = \$386.12$ which is comprised of \$100 of contributions and \$286.12 of interest. You are not taxed on any of your final withdraws so you end up with $386.12$
%        \end{compactenum}
%        This example should illuminate something - depending on your tax situation at retirement, there can be benefits to choosing one vehicle over another. Mathematically, it is better to contribute to your 401k before your Roth IRA if you believe that your tax rate in retirment will be lower than it is now. If you believe in the contrary, then you would chose to preference your Roth over your 401k. While each situation is different, here is my practial advice (in order of how you should do them):
%        \begin{compactenum}
%            \item Ensure you have a great emergency fund setup before you even begin to think about investing
%            \item Pay off all of your debts regardless of the denomination. This is guaranteed interest - something that you can never earn in the markets
%            \item Contribute to your 401k up to your employer stops matching
%            \item Contribute up to the maximum into your Roth IRA - you can always withdraw the contributions tax free at any time with no penalty
%            \item Think about post-tax options if you are looking to retire early
%            \item Contribute and max out your 401k
%        \end{compactenum}
%    \end{topic}
%
%    \begin{topic}{Sizing the Emergency Fund}
%        \noindent There are many theories on how to best size the emergency fund according to risk profiles and probability. The Emergency Fund is, in the most literal sense, you taking out an insurance policy on yourself, funded by yourself, for emergencies requiring cash. General advice indicates that you should have the maximum of the following scenerios: 
%        \begin{compactenum}
%            \item \$15,000 in cash
%            \item 6 months of living expenses including rent, food, insurance, car payments, repairs, etc
%        \end{compactenum}
%        Your emergency fund is a kind of insurnace, and you should NOT be optimizing for yield (return) on your money. This is boring money - you should prioritize your abilty to convert this into cash as easily as possible over anything else. My general rule is that unless I can have the money by the end of the day in my hand, it isn't worth it to earn the extra interest. Flexibilty is king for this account. 
%    \end{topic}
%
%    
%    
